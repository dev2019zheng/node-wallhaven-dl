...
export function StickySelectionBar({
  ...
  return (
    <div className="sticky bottom-4 z-10 flex flex-col gap-3 rounded-2xl border border-primary/28 bg-[var(--panel)]/96 p-4 shadow-[0_18px_38px_rgb(2_6_23_/_0.22)] backdrop-blur sm:flex-row sm:items-center sm:justify-between">
